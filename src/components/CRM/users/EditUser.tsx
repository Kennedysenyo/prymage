...
import { validateEditUserForm } from "@/features/users/users.service";
...
type UserType = Omit<Props["user"], "id">;
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <motion.div
        ...
        className="mt-6 bg-white rounded-2xl p-8 shadow-lg border border-red-200"
      >
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Deleting this user will remove all their data and assigned leads.
              ...
              <AlertDialog.Portal>
                ...
                <AlertDialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl p-8 shadow-2xl max-w-md w-full z-50">
                  ...
                  <AlertDialog.Description className="text-gray-600 mb-6">
                    ...
                    <strong>{formData.name}</strong>? This will permanently
                    remove their account, assigned leads, and all related data.
                    This action cannot be undone.
