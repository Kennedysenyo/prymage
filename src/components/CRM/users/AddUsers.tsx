          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                name="role"
                onChange={handleChange}
                className="w-full pl-12 text-gray-600 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#5B2CA5] transition-colors appearance-none"
                required
              >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                name="cnfrmPassword"
                onChange={handleChange}
                className="w-full pl-12 text-gray-600 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#5B2CA5] transition-colors"
                placeholder="••••••••"
                required
              />
              <button
